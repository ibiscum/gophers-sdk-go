...
This Gophers Go SDK call the Gophers API running on localhost:8080.

## General

Here you can follow an example that use the SDK.
This example calls the `healthz` and the `gophers` routes.
